...
.stButton>button, .stFormSubmitButton>button {{
  ...
  box-shadow:0 2px 6px {rgba(C['accent'],.3)} !important; width:100%;
}}
...
/* Sidebar buttons: the global sidebar text colour must not grey them out */
[data-testid="stSidebar"] .stButton>button, [data-testid="stSidebar"] .stFormSubmitButton>button {{ color:#fff !important; }}
[data-testid="stSidebar"] .stButton>button *, [data-testid="stSidebar"] .stFormSubmitButton>button * {{ color:#fff !important; }}
/* Download + secondary buttons stay subtle but still clearly outlined */
.stDownloadButton>button {{ background:{C['surface2']} !important; color:{C['text']} !important; border:1px solid {C['border2']} !important; box-shadow:none !important; font-weight:600 !important; }}
.stDownloadButton>button * {{ color:{C['text']} !important; }}
button[kind="secondary"] {{ background:{C['surface2']} !important; color:{C['text']} !important; border:1px solid {C['border2']} !important; box-shadow:none !important; }}
...
with st.sidebar:
    ...
    st.markdown(f"<div style='font-weight:700;font-size:1rem;color:{C['text']};margin-bottom:.4rem'>Quick add</div>", unsafe_allow_html=True)
